...
void help(char *progname)
{
    ...
    fprintf(stderr, "Usage: %s\n" \
                    ...
                    " [-c | --controller]..: controller firmware file\n" \
                    " [-a | --actuator]....: actuator firmware file\n", progname);
    fprintf(stderr, "-----------------------------------------------------------------------\n");
...
int main(int argc, char *argv[])
{
    ...
    char *controller_fw = (char*)"PARAMETER -c ANGEBEN";
    char *actuator_fw = (char*)"PARAMETER -a ANGEBEN";
