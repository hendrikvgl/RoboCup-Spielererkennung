...
path_to_behaviour = "../../lib/bitbots/modules/behaviour/body"
subfolders = ["common", "goalie", "kick_off", "one_time_kicker", "penalty", "team_player", "technical_challenges"]
    ...
    for line in fl:
        ...
        if "class" in line:
            ...
            if len(name):
                ...
                print "Drop File %s from Search!" % datei
...
os.system("dot verhalten.dt -Tpng -o Verhalten.png")