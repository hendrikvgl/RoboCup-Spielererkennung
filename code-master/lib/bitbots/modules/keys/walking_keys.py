...
""" Ob das Running selbst sagt dass es läuft, dies ist etwas anderes als DATA_KEY_WALKING_ACTIVE, weil das Walking einen Moment braucht, bis es wirklich läuft"""
