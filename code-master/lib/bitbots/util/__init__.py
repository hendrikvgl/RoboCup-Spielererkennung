...
.. automodule:: bitbots.util.config
...
from bitbots.util.resource_manager import find_resource
from bitbots.util.resource_manager import find_animation  # NOQA
from bitbots.util.resource_manager import find  # NOQA
from bitbots.util.resource_manager import generate_find  # NOQA
...
try:
    from bitbots.util.joints import load_joints_from_yaml
    from bitbots.util.joints import JointGroup
    ...
    Scope("Util").warning("bitbots.util.joints NICHT gefunden")
